...
@pytest.fixture()
def scenario_basic_60_min(car, spot, time_series, cost_options):
    spice_dict = get_spice_ev_scenario_dict(
...
@pytest.fixture()
def scenario_basic_10_min(car, spot, time_series, cost_options):
    spice_dict = get_spice_ev_scenario_dict(
...
def test_get_charging_characteristic_feed_in(scenario_basic_60_min, scenario_basic_10_min):
    for i in range(60):
        scenario_basic_60_min.localGenerationPower["GC1"][i] = 11
    charging_result = get_charging_characteristic((scenario_basic_60_min, scenario_basic_10_min), 0.05)
...
def test_get_charging_characteristic_cost(scenario_basic_60_min, scenario_basic_10_min):
    charging_result = get_charging_characteristic((scenario_basic_60_min, None), 0)
    assert round(charging_result["cost"], 4) == 0.5599

    for i in range(10):
        scenario_basic_10_min.localGenerationPower["GC1"][i] = 11
    charging_result = get_charging_characteristic((scenario_basic_10_min, None), 0.05)
...
def test_get_charging_characteristic_grid_energy(scenario_basic_60_min, scenario_basic_10_min):
    charging_result = get_charging_characteristic((scenario_basic_60_min, scenario_basic_10_min), 0)
